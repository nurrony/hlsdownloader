...
describe('FileService', () => {
  ...
  describe('getTargetPath', () => {
    test('should resolve correct path from URL', async () => {
  ...
  describe('saveStream', () => {
    test('should persist a Web ReadableStream to disk', async () => {
    ...
    test('should cleanup and throw on stream failure', async () => {
  ...
  describe('prepareDirectory', () => {
    test('should create deep directory structures for a given URL', async () => {
  ...
  describe('canWrite', () => {
    ...
    test('should return false if file exists and overwrite is false', async () => {
    ...
    test('should return true if file exists but overwrite is true', async () => {
    ...
    test('should throw if fs.access fails with non-ENOENT error', async t => {
