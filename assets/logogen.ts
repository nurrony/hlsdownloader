...
const lightSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 575 200" width="575" height="200">
    <defs>
        <style>
...
const darkSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 575 200" width="575" height="200">
    <defs>
        <style>
...
writeFileSync('hlsdownloader-light.svg', lightSvg, 'utf8');
writeFileSync('hlsdownloader-dark.svg', darkSvg, 'utf8');
writeFileSync('favicon.svg', faviconSvg, 'utf8');

console.warn('Files generated successfully with fully visible text.');
